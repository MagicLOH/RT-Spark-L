...
static rt_bool_t s_btnActiveStatus = false;
...
void Button_Init(void)
{
	...
	button_attach(&st_btnUp, LONG_PRESS_HOLD, &cb_onLongPress);
	button_attach(&st_btnUp, PRESS_UP, &cb_onPressUp);
	button_attach(&st_btnUp, PRESS_DOWN, &cb_onPressDown);

	button_attach(&st_btnDown, LONG_PRESS_HOLD, &cb_onLongPress);
	button_attach(&st_btnDown, PRESS_UP, &cb_onPressUp);
	button_attach(&st_btnDown, PRESS_DOWN, &cb_onPressDown);

	button_attach(&st_btnRight, LONG_PRESS_HOLD, &cb_onLongPress);
	button_attach(&st_btnRight, PRESS_UP, &cb_onPressUp);
	button_attach(&st_btnRight, PRESS_DOWN, &cb_onPressDown);

	button_attach(&st_btnLeft, LONG_PRESS_HOLD, &cb_onLongPress);
	button_attach(&st_btnLeft, PRESS_UP, &cb_onPressUp);
	button_attach(&st_btnLeft, PRESS_DOWN, &cb_onPressDown);
