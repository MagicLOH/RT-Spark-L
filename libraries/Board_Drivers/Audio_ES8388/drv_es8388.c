...
rt_err_t es8388_init(const char *i2c_name, rt_uint16_t pin)
{
    ...
    reg_write(ES8388_DACCONTROL3,
              0x04);  // 0x04 mute/0x00 unmute&ramp;DAC unmute and  disabled digital volume control soft ramp
    ...
    reg_write(ES8388_ADCCONTROL2,
              0x00);  //0x00 LINSEL & RINSEL, LIN1/RIN1 as ADC Input; DSSEL,use one DS Reg11; DSR, LINPUT1-RINPUT1
